...
export const Editar = () => {
  ...
  const URL = `https://backend-practica-necodex.vercel.app/api/practicantes/${state.uid}`;
    ...
    axios
      ...
      .then(() => {
        Swal.fire({
          ...
          position: 'top-end',
          icon: 'success',
          title: 'Practicante editado exitosamente!',
  ...
  return (
    <>
      <div className='flex items-center justify-center flex-col gap-5'>
        {/* Back Button */}
        <button
          className='flex items-start self-start mt-10 text-white focus:outline-none font-medium rounded-r-lg text-sm p-2.5 text-center dark:bg-[#1a1a1a] dark:hover:bg-[#1e847f]'
          type='button'
          title='Regresar'
          onClick={() => navigate('/')}
        >
        ...
        {/* Titulo */}
        <h1 className='flex font-large leading-tight text-4xl text-gray-300'>Editar practicante</h1>
